...
nav .accordion-item {
  width: 50px; /*background: rgba(32, 138, 90, .8);*/
}
nav .accordion-bar {
  white-space: nowrap;
  height: 40px;
  overflow: hidden; /* background: #399e71; */
}
nav .nav-list > li:hover .accordion-bar {
  background: rgba(32, 138, 90, 0.8);
  transition: all 0.3s ease;
}
nav .accordion-bar .nav-icon {
  position: absolute;
  z-index: 1;
  width: 50px;
  height: 40px;
...
nav .lev2-box dl dd a{
  color: #ccc
}
nav .lev2-box dl dd a:hover{
  color: #fff;
}
nav.close .nav-list .accordion-item:hover {
  width: 500px;
  background: rgba(32, 138, 90, 0.8);
  transition: all 0.3s;
}
nav.close .nav-list .accordion-item:hover .lev2-box {
  width: 450px;
  height: 260px;
  padding: 15px;
...
nav.open {
  width: 220px; /*transform: translate3d(0,0,0)*/
  transition: all 0.6s ease;
}
nav.open .accordion-item {
  width: 100%;
}
nav.open li.active .accordion-bar {
  background: rgba(32, 138, 90, 0.8);
}
nav.open .lev1-name {
  padding-left: 50px;
}
nav.open li.active .lev2-box {
  position: static;
  width: 100%;
  height: 200px;
  padding: 15px;
